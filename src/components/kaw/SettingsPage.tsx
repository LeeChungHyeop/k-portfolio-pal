...
import { RotateCcw, Download, Upload, FileSpreadsheet, Trash2 } from "lucide-react";
...
export function SettingsPage() {
  const { state, setProfile, setAllocation, resetAllocation, resetAll, importJson } = usePortfolioStore();
